...
public class PropertyString16 extends BaseProperty {
	
	public static final int TYPE_CODE = 0x0013;
	public static final String KEYWORD = "string16";
	public static final int ARRAY_SIZE = 16;

	private String[] values;
	
	public PropertyString16() {
		super(TYPE_CODE, 0);
	}
	
	public PropertyString16(String value) {
		super(TYPE_CODE, 0);
		this.values = new String[] {value};
	}
	
	public PropertyString16(String ... values) {
		super(TYPE_CODE, 0, ARRAY_SIZE, values.length);
		this.values = values;
	}
	
	public PropertyString16(List<String> values) {
	...
	public void read(StreamReader stream, int itemCount) throws IOException {
		...
		for (int i = 0; i < itemCount; i++) {
			values[i] = stream.readString(StringEncoding.UTF16LE, stream.readInt());
		}
	}
	...
	public void write(StreamWriter stream) throws IOException {
		for (String value : values) {
			...
			stream.writeString(value, StringEncoding.UTF16LE);
		}
	}
